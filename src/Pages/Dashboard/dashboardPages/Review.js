        ...
        <DashboardHome>
            <div className='text-center '>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <input name='reviewRating' style={{ padding: '5px', marginBottom: '20px', marginLeft: '32px', width: '50%' }} placeholder="" {...register("reviewRating", { required: true })} />
                    ...
                    <input name='profession' style={{ padding: '5px', marginBottom: '20px', width: '50%' }} defaultValue='profession' {...register("profession", { required: true })} />
                    {errors.reviewRating && <span>This field is required</span>}<br />

                    <label for='reviewDescription' style={{ color: '#020f24', marginRight: '15px', fontSize: '20px' }}>Review</label>
                    <input name='reviewDescription' defaultValue='Description' {...register("reviewDescription", { required: true })} style={{ height: '6vw', padding: '5px', marginBottom: '20px', marginLeft: '28px', width: '50%' }} /> <br />
